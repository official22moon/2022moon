...
contract Moon2022 is Context, IERC20, Ownable {
    ...
    string private _name = "2022MOON";
    string private _symbol = "2022M";
    ...
    address public marketingWallet = 0x55be7BEc1adF72a8c3beFD9271fA9a30c583Cbae;

    uint256 public _marketingFee = 6;

    uint256 private _previousMarketingFee = _marketingFee;

    uint256 public totalFeesTax = _taxFee.add(_liquidityFee).add(_marketingFee);
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 totalTaxForSwap = _liquidityFee.add(_marketingFee);
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        _taxFee = taxFee;
        totalFeesTax = _taxFee.add(_marketingFee).add(_liquidityFee);
